...
Note: There's still lingering issues at the firmware level for this beta that might result in communication issues and occasional run offs. Project leaders for Pybicks cite issues with the bluetooth chip itself and how data is being presented. These issues don't exist in project 1 (1 Hub). 
--------------
